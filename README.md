...
|---|---|
| `/setchannel` | Live match events (goals, cards, HT, FT, lineups) |
| `/setpredictionschannel` | Score prediction polls + MOTM voting |
| `/setresultschannel` | MOTM winners, prediction results, points awarded, pinned leaderboard |
| `/setsummarychannel` | Full match report, stats, YouTube highlights (1hr after FT) |
...
### 5. Leaderboard
- Auto-posted and pinned to the **results channel** after every match
...
- Posted 1 hour after full time to the **summary channel**
...
| `/setresultschannel` | Results, points & leaderboard channel |
| `/setsummarychannel` | Match reports & highlights channel |
