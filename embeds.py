...
def embed_commands_menu() -> discord.Embed:
    ...
    em.add_field(
        name="📌  Quick Setup",
        value=(
            "`/setchannel` — match notifications\n"
            "`/setpredictionschannel` — prediction polls + MOTM\n"
            "`/setresultschannel` — results + points\n"
            "`/setleaderboardchannel` — leaderboard\n"
...
def embed_startup(user: discord.ClientUser) -> discord.Embed:
    em = discord.Embed(
        ...
        description=(
            ...
            "3. `/setresultschannel` — prediction results & points\n"
            "4. `/setleaderboardchannel` — leaderboard\n"
...
def embed_help() -> discord.Embed:
    ...
    em.add_field(
        ...
        value=(
            ...
            "`/setresultschannel` — Results & points awarded\n"
            "`/setleaderboardchannel` — Leaderboard\n"
